# decompile by Rana Nadeem Rajput
# source code by Rajput Brand
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Rajput Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;95m'
    print ' \xe2\x80\xa2 THIS TOOL IS FREE SO DONT BUY FROM ANY ONE CONTACT ME 03082503436\xe2\x80\xa2 '
    time.sleep(2)
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY RANA NADEEM RAJPUT \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def crack_select():
    ...
    print 47 * '-'
    print ''
    print ' The process has completed 💓thanks for using my tools Rana Nadeem Rajput'
